        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-white">RealEstate</h3>
                <p className="text-xs text-gray-400">Premium Properties</p>
              </div>
            </div>
            <p className="text-sm text-gray-400 mb-4">
              Your trusted partner in finding the perfect property in Mumbai. We
              specialize in premium residential and commercial real estate.
            </p>
