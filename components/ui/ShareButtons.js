    ...
    <div className={`relative ${className}`}>
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <a
          ...
          className="flex items-center justify-center w-12 h-12 bg-green-500 text-white rounded-full hover:bg-green-600 transition-colors shadow-md hover:shadow-lg"
        ...
        <button
          ...
          className="flex items-center justify-center w-12 h-12 bg-gray-600 text-white rounded-full hover:bg-gray-700 transition-colors shadow-md hover:shadow-lg"
        ...
        {typeof navigator !== 'undefined' && navigator.share && (
          <button
            ...
            className="flex items-center justify-center w-12 h-12 bg-purple-600 text-white rounded-full hover:bg-purple-700 transition-colors shadow-md hover:shadow-lg lg:hidden"
            aria-label="Share"
          >
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
