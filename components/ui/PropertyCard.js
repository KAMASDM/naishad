        ...
        <div className="p-4 md:p-5">
          ...
          <div className="flex items-center justify-between pt-3 border-t border-gray-200">
            <div className="flex items-center text-gray-600">
              ...
              <span className="text-sm font-medium">{bedrooms || 0} BHK</span>
            </div>
            <div className="flex items-center text-gray-600">
              <svg
                className="w-5 h-5 mr-1"
              ...
              <span className="text-sm font-medium">{bathrooms || 0} Bath</span>
            </div>
            <div className="flex items-center text-gray-600">
              <svg
                className="w-5 h-5 mr-1"
              ...
              <span className="text-sm font-medium">{formatArea(sqft)}</span>
            </div>
          </div>
        </div>
      </div>
